...
Modify from: https://github.com/google/certificate-transparency/blob/master/python/ct/crypto/merkle.py
...
class MerkleVerifier(object):
    ...
    def verify_leaf_hash_inclusion(self, leaf_hash, leaf_index, proof, sth):
        ...
        Args:
            ...
            The root_hash from this STH will be compared against the
        ...
        if calculated_root_hash == sth['root_hash']:
            return True
        ...
        #                         sth['root_hash'].encode("base64").strip()))
